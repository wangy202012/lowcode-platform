...
const Logo: React.FC<IProps> = (props): React.ReactElement => {
  ...
  return (
    <div className="lowcode-plugin-logo">
      <div> <img src="//img.alicdn.com/imgextra/i2/O1CN01lNWGJi1xflgRfSgbk_!!6000000006471-55-tps-22-26.svg" alt="" /><span style={{fontSize:'18px',fontWeight:'bold',marginLeft:'10px',color:'#3e71f7'}}> {window.lcAppName}</span></div>
