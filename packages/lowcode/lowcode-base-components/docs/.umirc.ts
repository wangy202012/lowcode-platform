...
const productPath = `/lowcode-base-components@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('lowcode-base-components', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'lowcode-base-components': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
