...
import BackListPlugin from '../../plugins/plugin-back-list'
import HistoryRecordPlugin from '../../plugins/plugin-history-record'
import CustomSetterSamplePlugin from '../../plugins/plugin-custom-setter-sample';
import SetRefPropPlugin from '@alilc/lowcode-plugin-set-ref-prop';
import LogoSamplePlugin from '../../plugins/plugin-logo-sample';
import ShowInfoPlugin from '../../plugins/plugin-show-info'
import '../../global.scss';
...
async function registerPlugins() {
  ...
  await plugins.register(BackListPlugin);
  await plugins.register(ShowInfoPlugin);
  ...
  await plugins.register(HistoryRecordPlugin);
